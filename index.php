...
//@return xml,json,array
 $filters = array(
     ...
     "address_town" => array("451"),  //ilçe kodu
...
//print_r($Sahibinden->Liste('emlak',40,$filters,"array")); // Kiralık Ev Kategorisinden filtrelere uygun 40 kaydı array formatında döndürür
echo $Sahibinden->Liste('kiralik-daire',100,$filters,'json'); //Emlak Kategorisinden 20 Kaydı JSON formatında döndürür.
